...
#' @param boot Boolean indicating whether to return only a vector of statistics. The default is FALSE, which implies the object produced by nlminb2 will be returned
{
	...
	else
	{
		...
		else
		{
			...
			# Poids pour la matrice de l'̩cole
	...
	# Assignation des objets requis par contrc.fonc dans l'environnement parent
	...
	obj = nloptr::nloptr(x0 = theta0,eval_f = objective,eval_g_eq = contrc.fonc,opts = list("algorithm"="NLOPT_GN_ISRES"))
